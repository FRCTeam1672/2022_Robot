...
public class OldControls {
        ...
        public enum Buttons {
                P1_A(() -> player1.getAButtonPressed(), () -> player1.getAButton(),
                                () -> player1.getAButtonReleased()), P1_B(
                                                () -> player1.getBButtonPressed(),
                                                () -> player1.getBButton(),
                                                () -> player1.getBButtonReleased()), P1_X(
                                                                () -> player1.getXButtonPressed(),
                                                                () -> player1.getXButton(),
                                                                () -> player1.getXButtonReleased()), P1_Y(
                                                                                ...
                                                                                () -> player1.getYButtonReleased()), P1_LB(
                                                                                                ...
                                                                                                () -> player1.getLeftBumperReleased()), P1_RB(
                                                                                                                ...
                                                                                                                () -> player1.getRightBumperReleased()), P1_LJ(
                                                                                                                                () -> player1.getLeftStickButtonPressed(),
                                                                                                                                () -> player1.getLeftStickButton(),
                                                                                                                                () -> player1.getLeftStickButtonReleased()), P1_RJ(
                                                                                                                                                () -> player1.getRightStickButtonPressed(),
                                                                                                                                                () -> player1.getRightStickButton(),
                                                                                                                                                () -> player1.getRightStickButtonReleased()),

                P2_A(() -> player2.getAButtonPressed(), () -> player2.getAButton(),
                                () -> player2.getAButtonReleased()), P2_B(
                                                () -> player2.getBButtonPressed(),
                                                () -> player2.getBButton(),
                                                () -> player2.getBButtonReleased()), P2_X(
                                                                () -> player2.getXButtonPressed(),
                                                                () -> player2.getXButton(),
                                                                () -> player2.getXButtonReleased()), P2_Y(
                                                                                ...
                                                                                () -> player2.getYButtonReleased()), P2_LB(
                                                                                                ...
                                                                                                () -> player2.getLeftBumperReleased()), P2_RB(
                                                                                                                ...
                                                                                                                () -> player2.getRightBumperReleased()), P2_LJ(
                                                                                                                                () -> player2.getLeftStickButtonPressed(),
                                                                                                                                () -> player2.getLeftStickButton(),
                                                                                                                                () -> player2.getLeftStickButtonReleased()), P2_RJ(
                                                                                                                                                () -> player2.getRightStickButtonPressed(),
                                                                                                                                                () -> player2.getRightStickButton(),
                                                                                                                                                () -> player2.getRightStickButtonReleased());
