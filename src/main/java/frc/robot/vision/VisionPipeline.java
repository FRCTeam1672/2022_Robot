...
public class VisionPipeline implements edu.wpi.first.vision.VisionPipeline {
	...
	public void process(Mat source0) {
		...
		double filterContoursMaxWidth = 64.0;
		double filterContoursMinHeight = 4.0;
		double filterContoursMaxHeight = 74.0;
		double[] filterContoursSolidity = {73.65940278630092, 100.0};
		double filterContoursMaxVertices = 30.0;
		double filterContoursMinVertices = 7.0;
		double filterContoursMinRatio = 1.2;
		double filterContoursMaxRatio = 2.8;
