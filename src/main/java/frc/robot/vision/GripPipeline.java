...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double filterContoursMaxWidth = 61.0;
		double filterContoursMinHeight = 0.0;
		double filterContoursMaxHeight = 57.0;
		double[] filterContoursSolidity = {82.7338129496403, 100.0};
		double filterContoursMaxVertices = 57.0;
		double filterContoursMinVertices = 3.0;
		double filterContoursMinRatio = 0.0;
		double filterContoursMaxRatio = 3.45;
